...
scoreboard objectives add elbRun minecraft.custom:minecraft.sprint_one_cm
scoreboard objectives add elbPowerBase dummy
scoreboard objectives add elbPowerBase1000 dummy
scoreboard objectives add elbPowerAmplifier dummy
scoreboard objectives add elbPower10000 dummy
scoreboard objectives add elbPowerLevel dummy
scoreboard objectives add elbDepthStriderLevel dummy
...
scoreboard players set Amplifier elbPowerAmplifier 25
