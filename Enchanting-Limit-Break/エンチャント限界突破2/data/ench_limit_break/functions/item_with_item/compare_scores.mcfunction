...
execute if score @s DepthStrider = @e[tag=SourceItem,distance=0.001..1,limit=1] DepthStrider if score @s DepthStrider <= MaxLevel DepthStrider run scoreboard players add @s DepthStrider 1
