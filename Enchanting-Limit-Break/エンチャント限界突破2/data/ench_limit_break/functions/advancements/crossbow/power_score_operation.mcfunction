...
execute store result score @s PowerLevel run data get entity @s SelectedItem.tag.Enchantments[{id:"minecraft:power"}].lvl

# Score Operation
# Power enchantment arrow damage by 2.0 + 25% × (level + 1)
