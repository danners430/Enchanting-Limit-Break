...
execute store result entity @s Item.tag.Enchantments[{id:"minecraft:soul_speed"}].lvl short 1 if score @s SoulSpeed matches 1..10 run scoreboard players get @s SoulSpeed
execute if data entity @s[tag=!Enchanted] Item.tag.Enchantments[{id:"minecraft:soul_speed"}] if score @s SoulSpeed matches 1..10 run tag @s add Enchanted
