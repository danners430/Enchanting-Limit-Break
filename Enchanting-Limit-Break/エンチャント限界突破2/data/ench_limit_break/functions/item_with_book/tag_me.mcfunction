execute as @s[type=item,nbt={Item:{id:"minecraft:wooden_shovel"}}] at @s run data merge entity @s {Tags:["ToolEnch","MiscEnch"]}
execute as @s[type=item,nbt={Item:{id:"minecraft:stone_shovel"}}] at @s run data merge entity @s {Tags:["ToolEnch","MiscEnch"]}
...
execute as @s[type=item,nbt={Item:{id:"minecraft:wooden_sword"}}] at @s run data merge entity @s {Tags:["SwordEnch","MiscEnch"]}
execute as @s[type=item,nbt={Item:{id:"minecraft:stone_sword"}}] at @s run data merge entity @s {Tags:["SwordEnch","MiscEnch"]}
...
execute as @s[type=item,nbt={Item:{id:"minecraft:iron_helmet"}}] at @s run data merge entity @s {Tags:["HelmetEnch","ArmorEnch","MiscEnch"]}
...
execute as @s[type=item,nbt={Item:{id:"minecraft:carrot_on_a_stick"}}] at @s run data merge entity @s {Tags:["MiscEnch"]}
execute as @s[type=item,nbt={Item:{id:"minecraft:shears"}}] at @s run data merge entity @s {Tags:["ToolEnch","MiscEnch"]}
execute as @s[type=item,nbt={Item:{id:"minecraft:flint_and_steel"}}] at @s run data merge entity @s {Tags:["MiscEnch"]}

execute as @s[type=item,nbt={Item:{id:"minecraft:carved_pumpkin"}}] at @s run data merge entity @s {Tags:["HeadEnch","MiscEnch"]}
execute as @s[type=item,nbt={Item:{id:"minecraft:skeleton_skull"}}] at @s run data merge entity @s {Tags:["HeadEnch","MiscEnch"]}
execute as @s[type=item,nbt={Item:{id:"minecraft:wither_skeleton_skull"}}] at @s run data merge entity @s {Tags:["HeadEnch","MiscEnch"]}
execute as @s[type=item,nbt={Item:{id:"minecraft:zombie_head"}}] at @s run data merge entity @s {Tags:["HeadEnch","MiscEnch"]}
execute as @s[type=item,nbt={Item:{id:"minecraft:creeper_head"}}] at @s run data merge entity @s {Tags:["HeadEnch","MiscEnch"]}
execute as @s[type=item,nbt={Item:{id:"minecraft:player_head"}}] at @s run data merge entity @s {Tags:["HeadEnch","MiscEnch"]}
execute as @s[type=item,nbt={Item:{id:"minecraft:dragon_head"}}] at @s run data merge entity @s {Tags:["HeadEnch","MiscEnch"]}
